...
class CalculadoraDecoradaParaIngles:
    def __init__(self, calculadora):
        self.calculadora = calculadora
...
if __name__ == "__main__":
    ...
    calculadoraDecoradaParaIngles = CalculadoraDecoradaParaIngles(calculadora)
    print(
        "'three' + 'five' =",
        calculadoraDecoradaParaIngles.soma("three", "five"),
    )
