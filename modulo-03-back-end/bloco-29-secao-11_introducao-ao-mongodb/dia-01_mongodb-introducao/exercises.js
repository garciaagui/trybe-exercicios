...
// PASSO 01 -> docker cp ./books.json mongo-test:/tmp/books.json
// PASSO 02 -> docker exec mongo-test mongoimport -d exercises -c books --file /tmp/books.json --jsonArray
